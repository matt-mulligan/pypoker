...
from fixtures.cards import get_hand, get_player_hands_dict, get_tiebreaker_dicts
from pypoker.deck import Card, Deck
from pypoker.engine.logic.functions.outs import build_out_string, get_all_combinations_for_out_string, find_outs_scenarios
...
def test_when_claim_out_strings_then_correct_values_claimed(utilised_outs, out_string, drawable_cards, expected, request):
    ...
    actual = get_all_combinations_for_out_string(utilised_outs, out_string, drawable_cards)
    assert actual == expected
