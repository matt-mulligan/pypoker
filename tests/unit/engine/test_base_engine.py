...
def test_when_group_cards_by_suit_then_correct_dict_returned(base_engine, get_test_cards):
...
def test_when_group_cards_by_suit_and_suit_missing_then_not_in_return_list(base_engine, get_test_cards):
...
def test_when_group_cards_by_value_then_correct_dict_returned(base_engine, get_test_cards):
...
def test_when_find_consecutive_value_cards_and_run_size_and_single_values_then_correct_lists_returned(
    ...
    result = base_engine.find_consecutive_value_cards(cards, treat_ace_low=True, run_size=3)
...
def test_when_find_consecutive_value_cards_and_single_values_and_not_ace_low_then_correct_lists_returned(
    ...
    result = base_engine.find_consecutive_value_cards(cards, treat_ace_low=False, run_size=3)
